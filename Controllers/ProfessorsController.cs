...
namespace AllisonKieferMIS4200.Controllers
{
    public class ProfessorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "professorID,description,qtyCourse,informationID")] Professor professor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "professorID,description,qtyCourse,informationID")] Professor professor)
        {
            if (ModelState.IsValid)
            {
